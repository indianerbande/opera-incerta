 ...
 * tall either block is allowed to be. Both were things the functional template
 * got wrong inside a component, where they could not be tested.
 */
 ...
 * earlier version in the functional template rebuilt these lines by hand and
 * showed a bare `|` for `notes` while omitting several fields entirely.
 */
 ...
 * and two attempts in the functional template failed on exactly that — first a
 * guessed constant, then a measured font metric (`CONVENTIONS.md` C-F1).
 *
