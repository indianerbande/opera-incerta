/**
 * Pure layout rules. specification.md §8.2.
 *
...
/** Column geometry as specified in specification.md §8.2. */
...
/** Ideal widths used until the user has dragged a column. specification.md §8.2. */
