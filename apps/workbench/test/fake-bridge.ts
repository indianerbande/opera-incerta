...
export function baseBridge(): OperaIncertaBridge {
  return {
    ...
    adoptProject: async () => notScripted(),
    ...
    openProject: async () => ({ ok: true, value: { kind: 'cancelled' } }),
    ...
    gitStatus: async () => ({ ok: true, value: { root: null, entries: [], tracking: null, merging: false, hasCommit: false, branch: null, remote: null } }),
    ...
    exportDocument: async () => notScripted(),
    listStylesheets: async () => ({ ok: true, value: [] }),
    readStylesheet: async () => ({ ok: true, value: null }),
    writeStylesheet: async () => notScripted(),
    ...
    gitAmend: async () => notScripted(),
    gitLastMessage: async () => notScripted(),
    gitReadIgnore: async () => notScripted(),
    gitWriteIgnore: async () => notScripted(),
    gitCreateBranch: async () => notScripted(),
    gitSwitchBranch: async () => notScripted(),
    gitDeleteBranch: async () => notScripted(),
